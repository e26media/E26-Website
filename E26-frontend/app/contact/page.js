...
>
                ...
                <span className="d-block" style={{ fontSize: '0.95rem', opacity: '0.9' }}>
                    Fri - Sat: 4PM - 10PM
                        ...
                        {/* <div className="row g-xxl-7 g-4">
                            ...
                            <div className="col-lg-8" data-aos="zoom-in" data-aos-duration={2000}>
  ...
  <div className="col-lg-6" data-aos="zoom-in" data-aos-duration={2000}>
    <div className="contact-map">
      ...
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m12!1m8!1m3!1d14079.84629731354!2d74.8357185!3d12.863665!3m2!1i1024!2i768!4f13.1!2m1!1se26%20media!5e1!3m2!1sen!2sin!4v1770372056408!5m2!1sen!2sin"
        allowFullScreen
        loading="lazy"
  ...
  {/* BRANCH / OTHER OFFICE MAP */}
  <div className="col-lg-6" data-aos="zoom-in" data-aos-duration={2000}>
    <div className="contact-map">

      <h5 style={{ color: "#004f39", marginBottom: "10px" ,textAlign:'center'}}>
        E26 Media Private Limited
      </h5>
...
.custom-input:focus {
  outline: none;
  border-color: #004f39;
  box-shadow: 0 0 5px rgba(0,79,57,0.4);
}
